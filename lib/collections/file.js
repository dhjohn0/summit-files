      ...
      add: function (folderId, file, user) {
        return app.invoke(function (config, Folder, File, db, _, uuid) {
          ...
          return Folder.view('all', { key: newFile.folder } ).then(function (folders) {
            ...
            return File.view('by_full', { key: [newFile.folder, newFile.name] });
          }).then(function (files) {
            if (files && files.length)
              throw {
                message: 'File exists',
            ...
            this.emit('add:before', { file: newFile });
            ...
            this.emit('add:after', { file: _file });
            return addedFile;
          });
        });
      },
      edit: function (id, edit, user) {
        return app.invoke(function (File, _) {
          var file;
          ...
          return File.view('all', { key: id }).then(function (files) {
            ...
            return File.view('by_full', { key: [file.folder, file.name] });
          }).then(function (files) {
            ...
            this.emit('edit:before', { file: file });
            return File.put(file);
          }).then(function (_file) {
            this.emit('edit:after', { file: _file });
            return _file;
          });
        });
      },
      remove: function (id, user) {
        return app.invoke(function (File) {
          ...
          return File.view('all', { key: id }).then(function (files) {
            ...
            this.emit('remove:before', { file: file });
            return File.put(file);
          }).then(function (_file) {
            this.emit('edit:after', { file: _file });
            return _file;
