...
module.exports = function (app) {
    ...
    fields: {
      ...
      by_parent: {
        map: function (doc) {
          if (doc.type && doc.type === 'Folder') {
            emit(doc.parent ? doc.parent : '0', doc);
          }
        }
      },
      by_full: {
      	map: function (doc) {
          if (doc.type && doc.type === 'Folder') {
            emit([doc.parent ? doc.parent : '0', doc.name], doc);
          }
        }
      },
      by_owner: {
    ...
    methods: {
      ...
      add: function (folder, user) {
        return app.invoke(function (config, Folder, _, uuid) {
          ...
          if (newFolder.parent && newFolder.parent !== '0')
      ...
      edit: function (id, edit, user) {
        return app.invoke(function (Folder) {
          var folder;
